<template>
  <div class="older-page_bg">
    ...
    <div class="older-container">
      <div class="bread">
        <norm-layout text="五大服务大数据统计分析—服务商运营大统计分析" path="FiveService" :flag="null"></norm-layout>
      </div>
      <div class="left-panels">
        <screening-condition :serviceShop="serviceShop" @handleChangeForm="handleChangeForm" :serviceCarrierMap="serviceCarrierMap" v-if="serviceShop.length > 0"></screening-condition>
        <all-orders :thirtyOrderMap="thirtyOrderMap" :allOrderMap="allOrderMap"></all-orders>
        <service-order :serviceOrderWeekMap="serviceOrderWeekMap"></service-order>
        <service-class :serviceSortMap="serviceSortMap"></service-class>
      </div>
      <div class="centre-panels">
        <consumption-money :consumerMoneyMap="consumerMoneyMap"></consumption-money>
        <place-way :serviceChannalsMap="serviceChannalsMap"></place-way>
        <service-way :serviceTypeMap="serviceTypeMap"></service-way>
      </div>
      <div class="right-panels">
        <old-age :oldageMap="oldageMap"></old-age>
...
import ServiceClass from '@/views/FiveService/components/ServiceClass/index'
import ConsumptionMoney from './components/ConsumptionMoney/index'
import PlaceWay from './components/PlaceWay/index'
