<template>
  <div class="older-content">
    <norm-layout text="安装类型" :flag="false"></norm-layout>
...
export default {
  ...
  computed: {
    ServiceData () {
      let { chargeTotal, freeTotal1, freeTotal2 } = this.installData
      return {
        data: [
          // { name: '免费', value: freeTotal1 + freeTotal2 },
          { name: '免费', value: freeTotal1 }, // 2021年12月31日改成 只取 freeTotal1
          { name: '购买', value: chargeTotal }
        ],
        radius: ['60%', '76%'],
        center: ['52%', '53%'],
        title: '安装类型',
