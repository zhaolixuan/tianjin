<template>
  <div>
    <div v-if="isShowDetail">
      ...
      <park-list-details :detailObject="serviceData"></park-list-details>
    </div>
    ...
    <list-layout
      ...
      title="适老化改造场景展示————适老化公园改造"
    >
      <el-form :inline="true" :model="formData">
        <el-form-item label="适老化公园名称" class="search_select">
          <el-input
            class="head_left"
            placeholder="请输入适老化公园名称"
...
import ParkListDetails from "@/views/YanglaoshilaohuaService/components/OlderMap/DetialTip/parkListDetails.vue";
export default {
  ...
  data() {
    return {
      ...
      columns: [
        //   { label: "序号", prop: "id" },
        { label: "适老化公园名称", prop: "parkName" },
        { label: "所属街道", prop: "streetName" },
        { label: "所属社区", prop: "communityName" },
        { label: "所在位量", prop: "parkAddress"},
        { label: "绿化面积", prop: "afforestedArea" },
        // { label: "年龄", prop: "age" },
        { label: "建设内容", prop: "transformationContent" },
        // { label: "改造照片", prop: "street" },
        // { label: "改造后照片", prop: "community" },
