  ...
  <div class="detial_content">
    ...
    >
      ...
      :src="option.url"
        ...
        <iframe
          :src='`https://open.ys7.com/ezopen/h5/iframe?url=${option.url}&autoplay=1&accessToken=${accessToken}`'
          width="600"
          height="400"
          id="ysOpenDevice"
          class="video-js"
...
export default {
  ...
  data () {
    return {
      ...
      checkData: [],
      videoSrc:
        'http://221.238.176.117:83/ncg/10.0.4.135/7099/0/12010399001310008583/MAIN/TCP/live.m3u8&checkinfo=ewogICAidGltZSIgOiAiMjAyMTAzMDVUMTAwNzAyWiIsCiAgICJ1cmwiIDogImh0dHA6Ly8yMjEuMjM4LjE3Ni4xMTc6ODMvbmNnLzEwLjAuNC4xMzUvNzA5OS8wLzEyMDEwMzk5MDAxMzEwMDA4NTgzL01BSU4vVENQL2xpdmUubTN1OCIKfQo%3D&idinfo=EAAAAAAQAABcwoO0ug0q9iSQJs%2Fx%2Fm6DpWEs05TRDQGjovhxap8sJecJc%2Bpm%2B8bh1tJY5%2BAGYYo%3D',
      serviceData: [
        {
          ztCode: this.ztCode,
          servicer: '天津华夏科技有限公司',
      ...
      videoShow: true,
      params: {
        appKey: this.detailObject.appKey,
        appSecret: this.detailObject.appSecret
      },
      new: {
