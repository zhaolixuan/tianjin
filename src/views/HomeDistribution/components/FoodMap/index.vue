          ...
          switch (level) {
            ...
            case 10:
              ...
              _self.myDetailObject = {
                ...
                appKey: params.data.appKey, // 萤石监控appKey
                appSecret: params.data.appSecret,
      ...
      for (var indexCode in ztData) {
        if (ztData[indexCode].length > 0) {
          ztData[indexCode].map(ite => {
            ...
            singelFwPointDataItem.serviceRadiationRange = ite.serviceRadiationRange // 服务辐射范围
            singelFwPointDataItem.companyname = ite.companyname // 服务商
            singelFwPointDataItem.enterprisename =
            ite.enterprisename // 供餐企业
            singelFwPointDataItem.appKey = ite.appKey // 萤石监控appKey
            singelFwPointDataItem.appSecret = ite.appSecret // 萤石监控appSecret
            ...
            singelFwPointDataItem.videoUrl = ite.videoaddress ? ite.videoaddress : ''
            singelFwPointDataItem.serviceArea = ite.serviceArea
            singelFwPointDataItem.principalTelno =
            ite.principalTelno // 联系电话
        ...
        var fwztData = filteredGeoPoint
          ...
          .map(function (feature) {
            ...
            return {
              ...
              appKey: feature.appKey, // 萤石监控appKey
              appSecret: feature.appSecret, // 萤石监控appSecret
