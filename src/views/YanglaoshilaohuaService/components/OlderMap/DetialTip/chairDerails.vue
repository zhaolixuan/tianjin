 ...
 * @LastEditTime: 2022-12-12 08:51:49
 * @LastEditors: ZhangFengYuan
 * @Description: 
 * @FilePath: \tianjin\src\views\YanglaoshilaohuaService\components\OlderMap\DetialTip\chairDerails.vue
 * 
 -->
...
<template>
  <div>
    <div class="detial_content" v-if="detailsVisible">
      <div class="title">福一把楼道休息椅改造</div>
      <div class="tip_main">
        <div class="btn">
          ...
          <div class="item">
            <li class="detial_item">
              <div class="item_contnet">
                <span class="item_label">小区名称：</span>
                <span class="item_value">{{ serviceData.villageName }}</span>
              </div>
              <div class="item_contnet">
                <span class="item_label">福一把数量：</span>
                <span class="item_value">{{ serviceData.fuChairNum }}</span>
              </div>
            </li>
            <li class="detial_item">
              <div class="item_contnet">
                <span class="item_label">街道名称：</span>
                <span class="item_value">{{ serviceData.streetName }}</span>
              </div>
              <div class="item_contnet">
                <span class="item_label">社区名称：</span>
                <span class="item_value">{{ serviceData.communityName }}</span>
              </div>
            </li>
            <li class="detial_item">
              <div class="item_contnet">
                <span class="item_label">楼栋休息椅数量’：</span>
                <span class="item_value">{{
                  serviceData.buildingChairNum
                }}</span>
              </div>
              <div class="item_contnet">
                <span class="item_label">楼栋数量：</span>
                <span class="item_value">{{ serviceData.buildingNum }}</span>
              </div>
            </li>
            <li class="detial_item">
              <div class="item_contnet">
                <span class="item_label">楼栋明细：</span>
                <span class="item_value-phone">{{
                  serviceData.buildingDetail
                }}</span>
              </div>
            </li>
            <!-- 
