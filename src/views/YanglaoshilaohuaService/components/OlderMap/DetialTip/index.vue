          ...
          <div class="item">
            <li class="detial_item">
              <div class="item_contnet">
                ...
                <span class="item_value">{{ serviceData.name }}</span>
              </div>
              <div class="item_contnet">
                <span class="item_label">性别：</span>
                <span class="item_value">{{ serviceData.sex }}</span>
              </div>
            </li>
            <li class="detial_item">
              <div class="item_contnet">
              ...
              <div class="item_contnet">
                <span class="item_label">人员类别：</span>
                <span class="item_value">{{
                  serviceData.appraisalConclusion
                }}</span>
              </div>
            </li>
            <li class="detial_item">
              <div class="item_contnet">
                <span class="item_label">街道/乡镇：</span>
                <span class="item_value">{{ serviceData.street }}</span>
              </div>
              <div class="item_contnet">
                <span class="item_label">社区：</span>
                <span class="item_value">{{ serviceData.community }}</span>
              </div>
            </li>
            <li class="detial_item">
              <div class="item_contnet">
                <span class="item_label">联系电话：</span>
                <span class="item_value">{{ serviceData.phone }}</span>
              </div>
              <div class="item_contnet">
                <span class="item_label">人员类型：</span>
                <span class="item_value">{{ serviceData.peopleType }}</span>
              </div>
            </li>
            ...
            <li class="detial_item">
              ...
              <div class="item_contnet">
                <span class="item_label">补贴金额型：</span>
                <span class="item_value">{{ serviceData.subsidiesPrice }}</span>
              </div>
            </li>
            ...
            <li class="detial_item">
              <div class="item_contnet">
                <span class="item_label">改造项目：</span>
            ...
            <li class="detial_item" v-for="item in imgeData">
              <div class="item_contnet">
                <span class="item_label-list">{{ item.projectName }}</span>
...
export default {
  ...
  methods: {
    getStatisticsPList() {
      let params = {
        statisticsId: this.serviceData.id || "",
        //  statisticsId : 392
      };
      api
        ...
        .then((res) => {
          res.data.forEach((it) => {
            this.beforeList.push(it.photoBeforeJd);
            this.afterList.push(it.photoAfterJd);
          });
