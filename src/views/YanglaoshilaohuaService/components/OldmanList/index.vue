<template>
  <div class="older-content">
    <norm-layout text="适老化入户改造名单" :routerPath="path"></norm-layout>
    <list-layout
      :columns="columns"
      :tableData="tableData"
      :pageSize="pageSize"
...
import DetialTip from "../OlderMap/DetialTip/index.vue";
...
export default {
  ...
  data() {
    return {
      columns: [
        { label: "序号", prop: "id" },
        { label: "居住街道", prop: "street" },
        { label: "居住社区", prop: "community" },
        { label: "姓名", prop: "name" },
