<template>
  <div class="older-content">
    <norm-layout text="养老补贴政策覆盖人群"></norm-layout>
      ...
      getAllowanceIndexInfo({ streetCode, ...this.params }).then((res) => {
        ...
        this.SubsidyData = [
          ...
          },
          {
            allowType: '居家养老护理补贴',
            allowanceTypeTotal:
              Data.allowance_jujia_yanglao,
            path: {
              path: 'olderSubsidy',
              query: {
                allowancePolicy: '2',
                allowanceCategory: '居家养老护理补贴',
          ...
          {
            allowType: '百岁老人营养补贴',
            allowanceTypeTotal: Data.allowance_baisui_yingyang,
            path: {
              path: 'olderSubsidy',
              query: {
                allowanceType: '8',
                allowanceCategory: '百岁老人营养补贴',
                code: this.breadCrumbCodes,
              },
            },
          },
