...
export const createBar = (serData, max, flag, isFormatter) => {
    let number = 0
    ...
    return {
        ...
        label: {
            formatter: isFormatter == false ? serData : function name(params) {
                //是否显示半分比比
                return params.value + "个 " + (((params.value / number) * 100).toFixed(0)) + "%"
            },
            show: flag,
            position: 'right',
